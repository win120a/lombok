public @lombok.RequiredArgsConstructor
@lombok.experimental.FieldDefaults(level = lombok.AccessLevel.PRIVATE, makeFinal = true)
@lombok.experimental.WithBy class WithByTypes<T> {
    private final int a;
    ...
    public static void example() {
        new WithByTypes<String>(0, 0, (short) 0, ' ', (byte) 0, 0.0, 0.0F, true, "").withHBy(( < no type > x) ->(!x)).
        withFBy(( < no type > x) ->(x + 0.5));
    }
