public class PrivateNoArgsConstructor {
    ...
    public static @lombok.NoArgsConstructor(force = true)
    @lombok.Data
    @lombok.RequiredArgsConstructor class PrivateNoArgsConstructorExplicitBefore {
        private final int c;
    ...
    public static @lombok.Data
    @lombok.NoArgsConstructor(force = true)
    @lombok.RequiredArgsConstructor class PrivateNoArgsConstructorExplicitAfter {
        private final int d;
    ...
    @lombok.RequiredArgsConstructor class PrivateNoArgsConstructorExplicitNone {
        private final int e;
