public @lombok.EqualsAndHashCode
@lombok.ToString
@lombok.AllArgsConstructor class NullLibrary1 {
    @lombok.With
    String foo;
     ...
     */
    public @org.eclipse.jdt.annotation.NonNull
    @java.lang.SuppressWarnings("all") NullLibrary1 withFoo(final String foo) {
        return ((this.foo == foo) ? this : new NullLibrary1(foo));
    }

    public @java.lang.Override
    @java.lang.SuppressWarnings("all") boolean equals(final java.lang.@org.eclipse.jdt.annotation.Nullable Object o) {
        if ((o == this))
            return true;
    ...
    public @java.lang.Override
    @java.lang.SuppressWarnings("all") java.lang.@org.eclipse.jdt.annotation.NonNull String toString() {
