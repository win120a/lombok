...
@lombok.ToString
@lombok.AllArgsConstructor class NullLibrary2 {
    @lombok.With
    String foo;
    ...
    @java.lang.SuppressWarnings("all") NullLibrary2 withFoo(final String foo) {
        return ((this.foo == foo) ? this : new NullLibrary2(foo));
    }

    public @java.lang.Override
    @java.lang.SuppressWarnings("all") boolean equals(final @org.springframework.lang.Nullable java.lang.Object o) {
        if ((o == this))
            return true;
