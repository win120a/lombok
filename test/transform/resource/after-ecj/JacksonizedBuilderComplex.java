...
class JacksonizedBuilderComplex {
    ...
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "with", buildMethodName = "execute") class TestVoidName<T extends Number> {
    ...
    private static @Jacksonized
    @Builder(buildMethodName = "execute", setterPrefix = "with") <T extends Number> void testVoidWithGenerics(T number, int arg2, String arg3, JacksonizedBuilderComplex selfRef) {
    }
