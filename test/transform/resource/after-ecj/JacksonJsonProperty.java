...
public @Builder class JacksonJsonProperty {
    public static @java.lang.SuppressWarnings("all") class JacksonJsonPropertyBuilder {
         ...
         * @return {@code this}.
         */
        public @JsonProperty("kebab-case-prop")
        @JsonSetter(nulls = Nulls.SKIP)
        @java.lang.SuppressWarnings("all") JacksonJsonProperty.JacksonJsonPropertyBuilder kebabCaseProp(final String kebabCaseProp) {
    ...
    public @JsonProperty("kebab-case-prop")
    @JsonSetter(nulls = Nulls.SKIP)
    @java.lang.SuppressWarnings("all") void setKebabCaseProp(final String kebabCaseProp) {
        this.kebabCaseProp = kebabCaseProp;
    }
}