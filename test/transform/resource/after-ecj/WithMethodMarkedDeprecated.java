...
class WithMethodMarkedDeprecated {
    ...
    @java.lang.SuppressWarnings("all") WithMethodMarkedDeprecated withAnnotation(final int annotation) {
     ...
     */
    public @java.lang.Deprecated
    @java.lang.SuppressWarnings("all") WithMethodMarkedDeprecated withJavadoc(final int javadoc) {
