...
public @Jacksonized
@Builder
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = JacksonBuilderSingular.JacksonBuilderSingularBuilder.class) class JacksonBuilderSingular {
    public static @java.lang.SuppressWarnings("all")
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "", buildMethodName = "build") class JacksonBuilderSingularBuilder {
        ...
        public @JsonAnySetter
        @java.lang.SuppressWarnings("all") JacksonBuilderSingular.JacksonBuilderSingularBuilder any(final String anyKey, final Object anyValue) {
        ...
        public @JsonProperty("v_a_l_u_e_s")
        @java.lang.SuppressWarnings("all") JacksonBuilderSingular.JacksonBuilderSingularBuilder values(final java.util.Collection<? extends String> values) {
            if ((values == null)) {
        ...
        public @JsonAnySetter
        @java.lang.SuppressWarnings("all") JacksonBuilderSingular.JacksonBuilderSingularBuilder guavaAny(final String key, final Object value) {
        ...
        public @JsonProperty("guava_v_a_l_u_e_s")
        @java.lang.SuppressWarnings("all") JacksonBuilderSingular.JacksonBuilderSingularBuilder guavaValues(final java.lang.Iterable<? extends String> guavaValues) {
            if ((guavaValues == null)) {
        ...
        public @java.lang.SuppressWarnings("all") JacksonBuilderSingular build() {
            ...
            switch (((this.any$key == null) ? 0 : this.any$key.size())) {
                ...
                default:
                    ...
                    for (int $i = 0; ; ($i < this.any$key.size()) ;
                    $i++)
    ...
    private @JsonAnySetter
    @Singular("any") Map<String, Object> any;
    private @JsonProperty("v_a_l_u_e_s")
    @Singular List<String> values;
    private @JsonAnySetter
    @Singular("guavaAny") ImmutableMap<String, Object> guavaAny;
    private @JsonProperty("guava_v_a_l_u_e_s")
    @Singular ImmutableList<String> guavaValues;
