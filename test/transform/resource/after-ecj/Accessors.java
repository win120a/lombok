class AccessorsFluent {
    ...
    @lombok.Setter
    @lombok.experimental.Accessors(fluent = true) String fieldName = "";
...
class AccessorsChain {
    private @lombok.Setter
    @lombok.experimental.Accessors(chain = true) boolean isRunning;
...
class AccessorsFluentGenerics<T extends Number> {
    private @lombok.Setter
    @lombok.experimental.Accessors(fluent = true) String name;
...
class AccessorsFluentNoChaining {
    private @lombok.Setter
    @lombok.experimental.Accessors(fluent = true, chain = false) String name;
