...
class CheckerFrameworkBuilder {
    public static @java.lang.SuppressWarnings("all") class CheckerFrameworkBuilderBuilder {
        ...
        public @org.checkerframework.dataflow.qual.SideEffectFree
        @java.lang.SuppressWarnings("all") CheckerFrameworkBuilder build(CheckerFrameworkBuilder.@org.checkerframework.checker.calledmethods.qual.CalledMethods({"y", "z"}) CheckerFrameworkBuilderBuilder this) {
    ...
    @java.lang.SuppressWarnings("all") CheckerFrameworkBuilder.@org.checkerframework.common.aliasing.qual.Unique CheckerFrameworkBuilderBuilder builder() {
