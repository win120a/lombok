...
public @Builder class BuilderWithDeprecated {
    public static @java.lang.SuppressWarnings("all") class BuilderWithDeprecatedBuilder {
         ...
         */
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecated.BuilderWithDeprecatedBuilder dep1(final String dep1) {
            this.dep1 = dep1;
            return this;
        }
         ...
         */
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecated.BuilderWithDeprecatedBuilder dep2(final int dep2) {
            this.dep2 = dep2;
            return this;
        }

        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecated.BuilderWithDeprecatedBuilder string(final String string) {
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecated.BuilderWithDeprecatedBuilder strings(final java.util.Collection<? extends String> strings) {
            if ((strings == null)) {
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecated.BuilderWithDeprecatedBuilder clearStrings() {
            if ((this.strings != null))
                this.strings.clear();
            return this;
        }
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecated.BuilderWithDeprecatedBuilder number(final Integer number) {
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecated.BuilderWithDeprecatedBuilder numbers(final java.lang.Iterable<? extends Integer> numbers) {
            if ((numbers == null)) {
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecated.BuilderWithDeprecatedBuilder clearNumbers() {
            this.numbers = null;
            return this;
        }
