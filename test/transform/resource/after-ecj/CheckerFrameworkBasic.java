...
class CheckerFrameworkBasic {
    ...
    @java.lang.SuppressWarnings("all") CheckerFrameworkBasic withX(final int x) {
        return ((this.x == x) ? this : new CheckerFrameworkBasic(x, this.y, this.z));
    }

    public @org.checkerframework.dataflow.qual.Pure
    ...
    public @org.checkerframework.dataflow.qual.SideEffectFree
    @java.lang.SuppressWarnings("all") int getZ() {
        return this.z;
    }
    ...
    @org.checkerframework.common.returnsreceiver.qual.This CheckerFrameworkBasic setZ(final int z) {
        this.z = z;
        return this;
    }
    ...
    protected @org.checkerframework.dataflow.qual.Pure
    @java.lang.SuppressWarnings("all") boolean canEqual(final java.lang.Object other) {
