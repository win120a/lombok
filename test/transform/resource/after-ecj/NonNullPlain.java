...
@lombok.Setter
class NonNullPlain {
    public @Target({ElementType.FIELD, ElementType.METHOD, ElementType.PARAMETER, ElementType.LOCAL_VARIABLE})
    ...
    public @lombok.NonNull
    @java.lang.SuppressWarnings("all") int getI() {
        return this.i;
    }

    public @lombok.NonNull
    @java.lang.SuppressWarnings("all") String getS() {
        return this.s;
    }
