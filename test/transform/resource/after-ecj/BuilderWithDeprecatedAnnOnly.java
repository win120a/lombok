...
public @Builder class BuilderWithDeprecatedAnnOnly {
    public static @java.lang.SuppressWarnings("all") class BuilderWithDeprecatedAnnOnlyBuilder {
        ...
        @java.lang.SuppressWarnings("all") BuilderWithDeprecatedAnnOnly.BuilderWithDeprecatedAnnOnlyBuilder dep1(final int dep1) {
            this.dep1 = dep1;
            return this;
        }

        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecatedAnnOnly.BuilderWithDeprecatedAnnOnlyBuilder string(final String string) {
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecatedAnnOnly.BuilderWithDeprecatedAnnOnlyBuilder strings(final java.util.Collection<? extends String> strings) {
            if ((strings == null)) {
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecatedAnnOnly.BuilderWithDeprecatedAnnOnlyBuilder clearStrings() {
            if ((this.strings != null))
                this.strings.clear();
            return this;
        }
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecatedAnnOnly.BuilderWithDeprecatedAnnOnlyBuilder number(final Integer number) {
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecatedAnnOnly.BuilderWithDeprecatedAnnOnlyBuilder numbers(final java.lang.Iterable<? extends Integer> numbers) {
            if ((numbers == null)) {
        ...
        public @java.lang.Deprecated
        @java.lang.SuppressWarnings("all") BuilderWithDeprecatedAnnOnly.BuilderWithDeprecatedAnnOnlyBuilder clearNumbers() {
            this.numbers = null;
            return this;
        }
