...
class DelegateOnGetter {
    ...
    @Getter(lazy = true) java.util.concurrent.atomic.AtomicReference<java.lang.Object> bar = new java.util.concurrent.atomic.AtomicReference<java.lang.Object>();
    ...
    public @Delegate
    @java.lang.SuppressWarnings({"all", "unchecked"}) Bar getBar() {
